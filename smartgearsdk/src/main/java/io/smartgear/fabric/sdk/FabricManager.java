...
public class FabricManager {
     ...
     * @param txId 区块高度
     */
    public Map<String, String> queryTransitionByTransactionID(String txId) throws ProposalException, IOException, InvalidArgumentException,Exception {
        return org.getChannel().queryTransitionByTransactionID(txId);
    }
    ...
    public Map<String, String> joinPeer(String peerName, String peerEventHubName, String peerLocation, String peerEventHubLocation, boolean isEventListener) throws ProposalException, InvalidArgumentException {
        return org.getChannel().joinPeer(new SmartGearPeer(peerName, peerEventHubName, peerLocation, peerEventHubLocation, isEventListener));
    }
